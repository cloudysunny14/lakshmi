...
"""Base handler class for all crawler handlers.
"""
...
_DEFAULT_BASE_PATH = "/crawler"
_DEFAULT_PIPELINE_BASE_PATH = _DEFAULT_BASE_PATH + "/pipeline"


if pipeline:
  class PipelineBase(pipeline.Pipeline):
    """Base class for all pipelines within crawler framework.

    Rewrites base path to use pipeline library bundled with crawler.
    """
